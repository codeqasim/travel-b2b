      ...
      <div class="c8">
        <div class="list-wrapper mb-20">
          <div class="row row-rtl">
            <div class="c4 p-10">
              <a href="">
              <img class="main-img" src="<?php echo base_url(); ?>assets/img/hotel.jpg" title="Holiday Inn Citystars" alt="Holiday Inn Citystars">
              </a>
            </div>
            <div class="c8">
              <div class="row h-100">
        ...
        <form action="">
          ...
          <?php $this->load->view('partcials/cuppon'); ?>
          <?php $this->load->view('partcials/payment'); ?>
