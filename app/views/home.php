  ...
  <div class="contain">
    <div class="row">
      ...
      <div class="c4 offers">
        ...
        <img src="<?php echo base_url(); ?>assets/img/offer.jpeg" alt="offer" />
        </a>
      </div>
      <?php } ?>
    </div>
      ...
      <div class="c4">
        <div class="hotels-feature-items">
          <figure class="item-image">
            <div
              class="hotel-image"
              style='background-image: url("<?php echo base_url(); ?>assets/img/hotel.jpg");'
              ></div>
          </figure>
  ...
  <div class="contain">
    <div class="row">
      ...
      <div class="col-lg-5-2">
        <div class="country-recommendation" style="background-image: url('assets/img/dest.jpeg');">
