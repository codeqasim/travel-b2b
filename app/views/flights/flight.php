<div class="flight-itenrary-group">
    ...
    <div class="c9 c-sm-9 left-side">
      <div class="left-side-row has-stops">
          ...
          <div class="c3 c-sm-3 airline-info pr-0">
            ...
            <div class="flex flex-column items-center">
              <div class="airline-info__logo">
                <span class="logo-container"><span class="fit-alignment"></span><img id="WY.png-0-0" src="<?php echo base_url(); ?>assets/img/WY.png"></span>
              </div>
        ...
        <div class="bottom-options flex flex-content-between items-center">
          <label for="flight-detail-<?=$i?>" class="showDetails"> details <i class="icon-arrow-down"></i></label>
        </div>
        <input type="checkbox" name="flight-detail" id="flight-detail-<?=$i?>" hidden>
      ...
      <div class="left-side-row has-stops">
        ...
        <div class="bottom-options flex flex-content-between items-center">
          <label for="flight-detail-<?=$i+1?>" class="showDetails"> details <i class="icon-arrow-down"></i></label>
        </div>
        <input type="checkbox" name="flight-detail" id="flight-detail-<?=$i+1?>" hidden>
        <div class="flight-detail-card">
          <div class="flight-details">
            <div class="flight-detail-header flex flex-content-between row-rtl items-center">
              <h5>
    ...
    <div class="c3 c-sm-3">
      <div class="right-side">
        <div class="text-center flex flex-column flex-content-center h-100">
          ...
          <div class="price">
            <h4>
              <span class="price-hint ">1394</span>
